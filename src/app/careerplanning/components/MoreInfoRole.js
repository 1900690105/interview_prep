  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-8">
        {/* Hero Section */}
        <section
          className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-2xl p-8 mb-8 text-white shadow-xl"
          role="region"
          aria-labelledby="role-title"
        >
          <div className="max-w-3xl">
            <h1 id="role-title" className="text-4xl font-bold mb-4">
              {role?.role}
            </h1>
        ...
        <section
          className="grid gap-4 bg-white border rounded-2xl shadow-sm divide-y divide-gray-200"
          aria-label="Role Details Sections"
        >
          {/* Each SectionCard is focusable and toggleable */}
          <SectionCard
            ...
            ariaLabel="Core responsibilities for this role"
          />
          ...
          <SectionCard
            ...
            ariaLabel="Skills and qualifications required for this role"
          />
          ...
          <SectionCard
            ...
            ariaLabel="Latest tools and technologies used in this role"
          />
          ...
          <SectionCard
            ...
            ariaLabel="Typical work environment for this role"
          />
          ...
          <SectionCard
            ...
            content={
              <div className="mt-4" aria-label="Career progression path">
                <div className="flex flex-col gap-4">
                  {role?.careerPath?.map((path, index) => (
                    <div key={index} className="flex items-center gap-4">
                      <div
                        className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-500 font-medium"
                        aria-hidden="true"
                      >
                        {index + 1}
                      </div>
            ...
            ariaLabel="Career path progression steps"
          />
          ...
          <SectionCard
            ...
            ariaLabel="Challenges and rewards in this role"
          />
          ...
          <SectionCard
            ...
            ariaLabel="Companies that typically hire for this role"
          />
          ...
          <SectionCard
            ...
            content={
              <div className="space-y-6 mt-4">
                ...
                <div
                  ...
                  aria-label="Salary levels from junior to senior"
                >
                  {[
                    {
                      level: "Junior",
            ...
            ariaLabel="Average salary details by seniority level"
          />
        </section>
        ...
        >
          ...
          <div className="flex gap-5">
            <Button
              ...
              aria-label="Check your career fit"
            >
              Check My Career
            ...
            <Button
              ...
              aria-label="Continue to the career roadmap"
            >
              Continue to Roadmap
              <ArrowRight className="w-4 h-4" />
            </Button>
