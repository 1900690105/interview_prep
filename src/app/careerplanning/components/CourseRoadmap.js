...
function CourseRoadmap() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50" role="main">
      ...
      >
        {showSidebar && (
          <div className="p-6 h-full flex flex-col">
            ...
            <nav className="mb-8" aria-label="Recent course searches">
      ...
      {/* Main Content */}
      <section className="flex-1 p-6 lg:p-10" aria-label="Main content area">
        {/* Mobile Header */}
        ...
        <section aria-labelledby="search-heading" className="mb-8">
          <h1
            id="search-heading"
            className="text-3xl font-bold mb-6 text-gray-800 lg:hidden"
          >
            Course Roadmap
          </h1>
        ...
        {/* Roadmap Display */}
        {roadmap && (
          <section className="pb-20" aria-labelledby="roadmap-heading">
            <div className="text-center mb-8">
              <h2
                id="roadmap-heading"
                className="text-3xl lg:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"
              >
                {roadmap?.title}
              </h2>
            ...
            <div className="space-y-4">
              {roadmap?.modules?.map((module, index) => (
                ...
                >
                  <button
                    className="p-6 flex items-center justify-between w-full text-left cursor-pointer"
                    ...
                    >
                      <div className="pl-14">
                        ...
                        <div className="mt-6 flex justify-end">
                          <button
                            className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg shadow transition-colors duration-200 flex items-center gap-2"
