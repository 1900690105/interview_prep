              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-center mt-8">
                  <Button
                    ...
                    className="bg-blue-500 text-white px-8 py-3 text-base hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    aria-label="Submit the assessment"
                  >
                    Submit Assessment
                  </Button>
                </div>
