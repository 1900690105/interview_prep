            ...
            <div className="md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link
                  ...
                  title="Start learning your career path"
                  aria-label="Explore career paths - start learning"
                ...
                <Link
                  ...
                  aria-label="View job listings - Something is waiting for you"
