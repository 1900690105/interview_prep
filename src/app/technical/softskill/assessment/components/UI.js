...
const SoftSkillInterviewUI = () => {
  ...
  return (
    <>
      {activeSection ? (
        <main
          className="flex-grow container mx-auto px-4 py-8 grid md:grid-cols-3 gap-6"
          role="main"
        >
              ...
              <div className="space-y-4" key={ind}>
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <button
                    ...
                    aria-label={`Start assessment for ${skill.name}`}
                  >
                    Start Assessment
                  </button>
                </div>
            ...
            >
              <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center space-x-3">
                  <Book className="w-8 h-8" aria-hidden="true" />
            ...
            >
              ...
              >
                ...
                <section aria-labelledby="camera-section">
                  <div className="bg-gray-100 rounded-lg flex flex-col items-center justify-center p-4">
                    <h3
                    ...
                    <button
                      ...
                      className={`mt-3 px-4 py-2 rounded focus:outline-none focus:ring-2 ${
                        cameraActive
                ...
                {/* Saved Answers */}
                <section className="mt-4" aria-labelledby="saved-answers">
                  <h3
              ...
              >
                ...
                <div className="mt-6">
                  <label
                    ...
                    className="text-lg font-semibold text-blue-700 mb-2 block"
                  >
                    Your Answer
                  </label>
                  <textarea
                    ...
                    aria-label="Type or edit your answer"
                  />
                ...
                <div className="mt-6 flex justify-between items-center">
                  ...
                  <button
                    ...
                    aria-disabled={
                      currentSection === softSkillQuestions.length - 1
                    }
