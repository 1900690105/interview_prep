...
const CompanyResearchUI = () => {
  ...
  return (
    <main className="min-h-screen bg-blue-50 p-4 md:p-8" role="main">
      <div className="container mx-auto">
        ...
        <section aria-labelledby="research-section-heading">
          <h2 id="research-section-heading" className="sr-only">
          ...
          <ul className="grid md:grid-cols-2 lg:grid-cols-1 gap-6">
            {research.research_points.map((point, index) => {
              ...
              return (
                <li
                  key={point.topic}
                  className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-all duration-300 ease-in-out transform hover:-translate-y-2"
        ...
        <footer className="mt-8 text-center text-blue-900" aria-label="Tip">
          <p className="text-sm">
