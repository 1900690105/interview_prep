  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <main
        ...
        role="main"
        aria-labelledby="candidate-information"
      >
        <div className="grid lg:grid-cols-3 gap-8">
          <aside
            className="lg:col-span-1 space-y-6"
            aria-label="Progress and notes"
          >
            {/* Progress Card */}
            <Card role="region" aria-labelledby="interview-progress-title">
              <CardHeader>
                <CardTitle
                  id="interview-progress-title"
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <nav aria-label="Progress steps" className="space-y-4">
                    {[
            ...
            >
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm list-disc pl-4">
                  ...
                  <li>Allocate full 45 minutes without interruption</li>
          ...
          >
            <Card>
              ...
              <CardContent>
                ...
                <form
                  className="space-y-6"
                  aria-label="Candidate Information Form"
                >
