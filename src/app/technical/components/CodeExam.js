      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        >
          ...
          <section
            ...
            aria-labelledby="question-section"
          >
                ...
                <span
                  ...
                  aria-label={
                    isTimerRunning
                      ...
                      : `Estimated time required: ${questions[currentQuestionIndex].time_required}`
                  }
                >
                  {isTimerRunning
                    ? formatTime(timeLeft)
            ...
            <div className="flex space-x-2 mt-5">
              {!isTimerRunning ? (
                <button
                  onClick={startTimer}
                  className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300"
                ...
                <button
                  onClick={stopTimer}
                  className="flex items-center space-x-2 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-300"
        ...
        {check && (
          ...
          >
            <CodingRoundFeedback feedback={exam} />
          </section>
        )}
        ...
        >
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 text-blue-600 disabled:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300"
