      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        >
          <h1 className="text-2xl font-bold flex gap-2 items-center">
            ...
            >
              <FaArrowLeft className="cursor-pointer" title="Go Back" />
            </button>
            <span>Coding Assessment</span>
          </h1>
          <p className="text-blue-100 ml-8" aria-live="polite">
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <span
                  ...
                  role="status"
                  aria-label={`Difficulty level: ${questions[currentQuestionIndex].level}`}
                >
                  {questions[currentQuestionIndex].level}
                </span>
                <div
              ...
              <div className="flex space-x-2 mt-5">
                {!isTimerRunning ? (
                  <button
                    onClick={startTimer}
                    className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    aria-label="Start timer for this question"
                  >
                  ...
                  <button
                    onClick={stopTimer}
                    className="flex items-center space-x-2 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                    aria-label="Stop timer for this question"
                  >
        ...
        >
          <button
            ...
            disabled={currentQuestionIndex === 0 || isTimerRunning}
            className="flex items-center space-x-2 px-4 py-2 text-blue-600 disabled:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:focus:ring-0"
