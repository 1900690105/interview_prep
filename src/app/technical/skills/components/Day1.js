...
const StepCard = ({ step, index }) => (
  ...
  >
    <div className="md:flex md:justify-between">
      ...
      <div className="p-6 md:pt-16 pt-6 flex justify-center items-center">
        <Image
          src={`/${step.img}`}
          height={300}
          width={300}
          alt={step.alt || "Step illustration"}
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          ...
          role="list"
          aria-label="Steps to master active listening"
        >
          {Activelisteing.map((step, index) => (
