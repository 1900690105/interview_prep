...
const CourseExam = ({ exam, topicName, totalTime = 30 * 60 }) => {
  ...
  return (
    <>
      <a
        href="#main-exam"
        className="sr-only focus:not-sr-only absolute top-2 left-2 bg-white p-2 z-50 rounded-md shadow"
      >
      ...
      >
        <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-2xl">
          {showResult ? (
            <section role="region" aria-live="polite" aria-label="Exam Results">
              ...
              {score >= passingScore ? (
                <p className="text-green-600 font-semibold">
                  Congratulations! You’re on the right track—keep up the hard
                  work!
                </p>
              ) : (
                <>
            ...
            <>
              ...
              <section role="region" aria-label="Question">
                ...
                {showExplanation && (
                  <section
                    className="mt-4 p-4 bg-blue-50 rounded-lg flex items-start"
                    role="region"
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg transition duration-300 mt-6 ${
                  selectedOption
