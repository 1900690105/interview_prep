  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <header
        ...
        role="banner"
        aria-label="Study Plan Overview"
      >
      ...
      {/* Main content */}
      <main className="max-w-4xl mx-auto" role="main" id="study-plan-main">
        <section aria-label="Weekly Study Plan">
          {data?.studyPlan?.weeks?.map((week) => (
            <Card key={week.weekNumber} className="mb-6 overflow-hidden">
              <CardHeader
                ...
                aria-controls={`week-${week.weekNumber}`}
              >
              ...
              {expandedWeek === week.weekNumber && (
                <CardContent
                  ...
                  role="region"
                  aria-label={`Content for week ${week.weekNumber}`}
                >
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="font-semibold text-gray-900 flex items-center gap-2">
                            <Clock
                              className="h-4 w-4 mt-1 flex-shrink-0 text-gray-400"
                              aria-hidden="true"
                            />
                            Day {day.day}
                          </h3>
                        ...
                        <ul
                          className="space-y-2"
                          aria-label={`Tasks for Day ${day.day}`}
                        >
                          {day?.tasks?.map((task, index) => (
                            <li
                              key={index}
                              className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-gray-700"
                            >
            ...
            <CardContent>
              ...
              <div className="flex justify-end mt-5">
                <Button
                  ...
                  aria-label="Change current study plan"
                >
                  Change
                </Button>
              </div>
