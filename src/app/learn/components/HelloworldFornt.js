...
const FirstProgram = () => {
  ...
  return (
    <div
      className="container mx-auto px-4 py-8 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen"
      role="main"
      aria-labelledby="generate-program-heading"
    >
      <Card
      ...
      >
        <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardTitle
            id="generate-program-heading"
            className="text-2xl font-bold flex items-center"
          >
            <Code className="mr-2" aria-hidden="true" />
        ...
        <CardContent className="p-6">
          <form
            onSubmit={showProgram}
            className="space-y-4"
            aria-label="Program Generation Form"
          >
            ...
            <Button
              ...
              disabled={loading}
              aria-label="Generate program button"
            >
              {loading ? (
                "Generating..."
              ) : (
      ...
      {code && (
        <section
          ...
          tabIndex={-1}
        >
          <h2 id="generated-code-heading" className="sr-only">
            Generated Code Output
          </h2>
