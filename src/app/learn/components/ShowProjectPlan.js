...
const Project_plan = ({ setPlanStatus, setCheck }) => {
  ...
  return (
    <div
      className="min-h-screen bg-blue-50 p-4 sm:p-8"
      role="main"
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
              ...
              {plan.projectPlan?.map((dayPlan) => (
                <AccordionItem key={dayPlan?.day} value={`day-${dayPlan?.day}`}>
                  <AccordionTrigger
                    ...
                    aria-label={`Expand details for Day ${dayPlan?.day}`}
                  >
                  ...
                  <AccordionContent
                    className="p-4 bg-blue-50 border"
                    aria-labelledby={`day-${dayPlan.day}-details`}
                  >
                    <div
                      className="grid grid-cols-1 sm:grid-cols-1 gap-4 p-2 m-2"
                      role="region"
                      aria-labelledby={`day-${dayPlan.day}-title`}
                    >
                      <h3
                        id={`day-${dayPlan.day}-title`}
                        className="sr-only"
                      >{`Day ${dayPlan.day} Details`}</h3>
          ...
          <CardFooter
            className="bg-blue-50 p-4 sm:p-6 flex justify-between items-center"
            role="contentinfo"
            aria-label="Project footer actions"
          >
            ...
            <Button
              ...
              aria-label="Mark project as completed and move to next level"
            >
              Completed
            </Button>
          </CardFooter>
