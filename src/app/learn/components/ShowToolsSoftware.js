...
function ShowToolsSoftware({ tools, value }) {
  ...
  return (
    <div
      className="dark:from-gray-900 dark:to-gray-800 p-4 md:p-8"
      role="main"
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1
                ...
                className="text-4xl font-bold bg-gradient-to-r from-blue-50 to-cyan-200 bg-clip-text text-transparent"
              >
                Engineering Tools
              </h1>
            ...
            <div
              ...
              role="group"
              aria-label="View toggle buttons"
            >
              <button
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    aria-label="Top companies using this tool"
                  >
                  ...
                  <Button
                    ...
                    aria-label={`Get course for ${tool.name}`}
                  >
                    Get Course
                  </Button>
                </div>
