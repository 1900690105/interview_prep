...
export default function ResumeExtractor() {
  ...
  return (
    ...
    >
      ...
      {/* File Upload Area */}
      <div
        className={`border-2 border-dashed rounded-lg p-8 mb-6 text-center focus:outline-none ${
        ...
        tabIndex={0}
      >
        <div id="file-upload-heading" className="sr-only">
          File Upload Area
        </div>
      ...
      {/* Extracted Text */}
      {text && !loading && (
        <section aria-labelledby="extracted-heading" className="mt-6">
      ...
      <Button
        ...
        aria-label="Analyze resume with job description"
      >
      ...
      {miss && (
        <section
          className="mt-5 flex flex-col md:flex-row gap-5 bg-gray-50 p-4 rounded-lg border border-gray-200"
        ...
        >
          ...
          {/* Missing Skills */}
          <div>
            <p className="font-bold">Courses & Points to Learn</p>
            {miss?.missing_skills?.map((skill, index) => (
              <button
                ...
                className="cursor-pointer border mt-2 rounded-xl bg-blue-500 text-white w-full"
                aria-label={`Learn ${skill}`}
              >
                <p className="p-2 mt-2 flex gap-2 items-center justify-center">
                  {skill} <IoIosArrowForward aria-hidden="true" />
                </p>
              </button>
            ))}
          </div>
          ...
          {/* Refresh Skills */}
          <div>
            <p className="font-bold">Courses & Points to Refresh</p>
