    ...
    <div className="relative min-h-screen bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 flex items-center justify-center overflow-hidden">
      ...
      >
        <section
          ...
          role="region"
          aria-label="Hero call-to-action section"
        >
          <h1
            id="hero-heading"
            className="text-6xl font-extrabold text-white mb-6 tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-blue-100"
          >
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-blue-900/20 to-transparent pointer-events-none"
        aria-hidden="true"
      ></div>
      <div
