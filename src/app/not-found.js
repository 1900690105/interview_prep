  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div
          className="absolute inset-0 text-9xl md:text-[12rem] font-black text-purple-500/20 animate-pulse"
          aria-hidden="true"
        >
          404
        </div>
        ...
        <section
          ...
          aria-labelledby="error-subheading"
        >
          <h2
            id="error-subheading"
        ...
        >
          <button
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-300"
          ...
          <button
            ...
            className="group px-8 py-4 border-2 border-gray-600 text-gray-300 font-semibold rounded-xl transition-all duration-300 hover:border-gray-400 hover:text-white hover:bg-gray-600/10 active:scale-95 focus:outline-none focus:ring-2 focus:ring-gray-400"
        ...
        >
          <p className="text-gray-400 text-sm mb-3" id="search-instruction">
          ...
          >
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-white/10 border border-white/20 rounded-xl text-white hover:bg-white/20 transition-all focus:outline-none focus:ring-2 focus:ring-purple-500"
          ...
          {/* Optional live region for dynamic results or error */}
